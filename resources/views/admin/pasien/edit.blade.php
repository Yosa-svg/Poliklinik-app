    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="flex items-center gap-3 mb-6">
            ...
            <div>
                ...
                <p class="text-gray-500 text-sm">Perbarui data pasien di bawah ini.</p>
            </div>
        </div>
            ...
            <form action="{{ route('pasien.update', $pasien->id) }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <textarea name="alamat" id="alamat" rows="3" required
                        class="w-full px-4 py-2.5 border-2 border-gray-200 rounded-xl text-sm focus:outline-none focus:border-blue-500 transition-all resize-none @error('alamat') border-red-400 bg-red-50 @enderror">{{ old('alamat', $pasien->alamat) }}</textarea>
