<x-layouts.app title="Tambah Poliklinik">
    <div class="max-w-2xl mx-auto">
        ...
        <div class="flex items-center gap-3 mb-6">
            ...
            <div>
                <h1 class="text-2xl font-bold text-gray-800">Tambah Poliklinik</h1>
                <p class="text-gray-500 text-sm">Isi data poliklinik baru di bawah ini.</p>
            </div>
        </div>

        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <form action="{{ route('poliklinik.store') }}" method="POST" class="space-y-5">
                @csrf
                <div>
                    ...
                    <input type="text" name="nama_poli" id="nama_poli" value="{{ old('nama_poli') }}" required
